...
//to generate a random string to seed the hash
...
//use module.exports in order to properly establish a namespace
module.exports = {
  ...
  sendVerificationEmail: function(req, email) {
    ...
    this.dbConnection.query(updateSQL, function(err, rows) {
      if (err) throw err;
